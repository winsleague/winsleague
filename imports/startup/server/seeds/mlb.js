...
export default {
  ...
  createTeams() {
    ...
    teams.forEach((team) => {
      ...
      insertTeam.leagueId = leagueId;
      LeagueTeams.insert(insertTeam);
    });
  },
